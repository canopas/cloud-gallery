...
abstract class $AlbumCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String path, String id, MediaProvider provider});
}
...
class _$AlbumImpl implements _Album {
  ...
  @override
  String toString() {
    return 'Album(name: $name, path: $path, id: $id, provider: $provider)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, path, id, provider);
...
abstract class _Album implements Album {
  const factory _Album(
      ...
      required final MediaProvider provider}) = _$AlbumImpl;
